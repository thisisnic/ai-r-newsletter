# Fetch Substack/RSS feeds listed in sources/substacks.csv and write any new
# items into content/<week>/*.md.
...
sources <- read_csv("sources/substacks.csv", show_col_types = FALSE)
week <- week_key()
seen <- read_seen()
